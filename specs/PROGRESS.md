...
- [x] Frontend implemented (Delete button opens a confirmation modal; cancel leaves the bug intact; confirmed delete removes the bug, closes the edit modal, and refreshes the board)
- [x] Linter/errors resolved
